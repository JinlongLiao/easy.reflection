...
public class JavaCodeSerializerTest {
    ...
    public static void generateAndSave() {
        Predicate<String> filter = new ScannerFilter().include("io.github.jinlongliao.easy.reflection.TestModel\\$.*");
        ...
        //save
        String filename = ReflectionsTest.getUserDir() + "/src/test/java/io.github.jinlongliao.easy.reflection.MyTestModelStore";
    ...
    public void resolve() throws NoSuchMethodException, NoSuchFieldException {
        ...
        assertEquals(TestModel.C1.class,
                JavaCodeSerializer.resolveClass(MyTestModelStore.io.github.jinlongliao.easy.reflection.TestModel$C1.class));

        //method
        assertEquals(TestModel.C4.class.getDeclaredMethod("m1"),
                JavaCodeSerializer.resolveMethod(MyTestModelStore.io.github.jinlongliao.easy.reflection.TestModel$C4.methods.m1.class));

        //overloaded method with parameters
        assertEquals(TestModel.C4.class.getDeclaredMethod("m1", int.class, String[].class),
                JavaCodeSerializer.resolveMethod(MyTestModelStore.io.github.jinlongliao.easy.reflection.TestModel$C4.methods.m1_int__java_lang_String$$.class));

        //overloaded method with parameters and multi dimensional array
        assertEquals(TestModel.C4.class.getDeclaredMethod("m1", int[][].class, String[][].class),
                JavaCodeSerializer.resolveMethod(MyTestModelStore.io.github.jinlongliao.easy.reflection.TestModel$C4.methods.m1_int$$$$__java_lang_String$$$$.class));

        //field
        assertEquals(TestModel.C4.class.getDeclaredField("f1"),
                JavaCodeSerializer.resolveField(MyTestModelStore.io.github.jinlongliao.easy.reflection.TestModel$C4.fields.f1.class));
    }
}
