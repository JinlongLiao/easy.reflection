...
package io.github.jinlongliao.easy.reflection.exception;
...
public class ReflectionsException extends RuntimeException {
     ...
     * @since 1.7
     */
    protected ReflectionsException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
